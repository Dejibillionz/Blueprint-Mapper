...
export const partners: Partner[] = [
  ...
  { id:  9, name: "PINGU EXCHANGE", description: "A perpetual DEX on Monad powered by Pyth Network, enabling native trading across virtually all asset classes — from crypto to RWAs. Trade on margin and settle positions using the gas token or selected ERC-20s like LSTs and blue-chip assets. 10K Squad holders get an exclusive Discord role with a +0.3x multiplier in Pingu's points system and instant Tier 2 access in the referral program.", imageUrl: "/partners/pingu.jpg", linkUrl: "https://x.com/PinguExchange" },
